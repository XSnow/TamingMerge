...
Definition exp_mutind :=
  ...
  exp_ind' H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13.

Scheme exp_rec' := Induction for exp Sort Set.

Definition exp_mutrec :=
  fun H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 =>
  exp_rec' H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13.
...
Fixpoint close_exp_wrt_exp_rec (n1 : nat) (x1 : var) (e1 : exp) {struct e1} : exp :=
  match e1 with
    ...
    | e_pair e2 e3 => e_pair (close_exp_wrt_exp_rec n1 x1 e2) (close_exp_wrt_exp_rec n1 x1 e3)
    | e_projl e2 => e_projl (close_exp_wrt_exp_rec n1 x1 e2)
    | e_projr e2 => e_projr (close_exp_wrt_exp_rec n1 x1 e2)
...
Fixpoint size_typ (A1 : typ) {struct A1} : nat :=
  match A1 with
    ...
    | t_prod A2 B1 => 1 + (size_typ A2) + (size_typ B1)
  end.
...
Fixpoint size_exp (e1 : exp) {struct e1} : nat :=
  match e1 with
    ...
    | e_pair e2 e3 => 1 + (size_exp e2) + (size_exp e3)
    | e_projl e2 => 1 + (size_exp e2)
    | e_projr e2 => 1 + (size_exp e2)
...
Inductive degree_exp_wrt_exp : nat -> exp -> Prop :=
  ...
  | degree_wrt_exp_e_pair : forall n1 e1 e2,
    degree_exp_wrt_exp n1 e1 ->
    degree_exp_wrt_exp n1 e2 ->
    degree_exp_wrt_exp n1 (e_pair e1 e2)
  | degree_wrt_exp_e_projl : forall n1 e1,
    degree_exp_wrt_exp n1 e1 ->
    degree_exp_wrt_exp n1 (e_projl e1)
  | degree_wrt_exp_e_projr : forall n1 e1,
    degree_exp_wrt_exp n1 e1 ->
    degree_exp_wrt_exp n1 (e_projr e1)
...
Definition degree_exp_wrt_exp_mutind :=
  fun H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 =>
  degree_exp_wrt_exp_ind' H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13.
...
Inductive lc_set_exp : exp -> Set :=
  ...
  | lc_set_e_pair : forall e1 e2,
    lc_set_exp e1 ->
    lc_set_exp e2 ->
    lc_set_exp (e_pair e1 e2)
  | lc_set_e_projl : forall e1,
    lc_set_exp e1 ->
    lc_set_exp (e_projl e1)
  | lc_set_e_projr : forall e1,
    lc_set_exp e1 ->
    lc_set_exp (e_projr e1)
