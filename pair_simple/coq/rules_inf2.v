...
Definition dexp_mutind :=
  ...
  dexp_ind' H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13.

Scheme dexp_rec' := Induction for dexp Sort Set.

Definition dexp_mutrec :=
  fun H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 =>
  dexp_rec' H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13.
...
Fixpoint close_dexp_wrt_dexp_rec (n1 : nat) (x1 : var) (ee1 : dexp) {struct ee1} : dexp :=
  match ee1 with
    ...
    | de_pair ee2 ee3 => de_pair (close_dexp_wrt_dexp_rec n1 x1 ee2) (close_dexp_wrt_dexp_rec n1 x1 ee3)
    | de_projl ee2 => de_projl (close_dexp_wrt_dexp_rec n1 x1 ee2)
    | de_projr ee2 => de_projr (close_dexp_wrt_dexp_rec n1 x1 ee2)
...
Fixpoint size_dexp (ee1 : dexp) {struct ee1} : nat :=
  match ee1 with
    ...
    | de_pair ee2 ee3 => 1 + (size_dexp ee2) + (size_dexp ee3)
    | de_projl ee2 => 1 + (size_dexp ee2)
    | de_projr ee2 => 1 + (size_dexp ee2)
    | de_ann ee2 _ => 1 + (size_dexp ee2)
...
Inductive degree_dexp_wrt_dexp : nat -> dexp -> Prop :=
  ...
  | degree_wrt_dexp_de_pair : forall n1 ee1 ee2,
    degree_dexp_wrt_dexp n1 ee1 ->
    degree_dexp_wrt_dexp n1 ee2 ->
    degree_dexp_wrt_dexp n1 (de_pair ee1 ee2)
  | degree_wrt_dexp_de_projl : forall n1 ee1,
    degree_dexp_wrt_dexp n1 ee1 ->
    degree_dexp_wrt_dexp n1 (de_projl ee1)
  | degree_wrt_dexp_de_projr : forall n1 ee1,
    degree_dexp_wrt_dexp n1 ee1 ->
    degree_dexp_wrt_dexp n1 (de_projr ee1)
...
Definition degree_dexp_wrt_dexp_mutind :=
  fun H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 =>
  degree_dexp_wrt_dexp_ind' H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13.
...
Inductive lc_set_dexp : dexp -> Set :=
  ...
  | lc_set_de_pair : forall ee1 ee2,
    lc_set_dexp ee1 ->
    lc_set_dexp ee2 ->
    lc_set_dexp (de_pair ee1 ee2)
  | lc_set_de_projl : forall ee1,
    lc_set_dexp ee1 ->
    lc_set_dexp (de_projl ee1)
  | lc_set_de_projr : forall ee1,
    lc_set_dexp ee1 ->
    lc_set_dexp (de_projr ee1)
