(* generated by Ott 0.31, locally-nameless lngen from: ../spec/rules.ott ../spec/dunfield.ott ../spec/icfp.ott *)
...
Inductive exp : Set :=  (*r expressions *)
 ...
 | e_pair (e1:exp) (e2:exp) (*r pair *)
 | e_projl (e:exp) (*r projection 1 *)
 | e_projr (e:exp) (*r projection 2 *)
...
Inductive dexp : Set :=  (*r expressions *)
 ...
 | de_pair (ee1:dexp) (ee2:dexp) (*r pair *)
 | de_projl (ee:dexp) (*r projection 1 *)
 | de_projr (ee:dexp) (*r projection 2 *)
...
Fixpoint open_dexp_wrt_dexp_rec (k:nat) (ee_5:dexp) (ee__6:dexp) {struct ee__6}: dexp :=
  ...
  | (de_pair ee1 ee2) => de_pair (open_dexp_wrt_dexp_rec k ee_5 ee1) (open_dexp_wrt_dexp_rec k ee_5 ee2)
  | (de_projl ee) => de_projl (open_dexp_wrt_dexp_rec k ee_5 ee)
  | (de_projr ee) => de_projr (open_dexp_wrt_dexp_rec k ee_5 ee)
...
Fixpoint open_exp_wrt_exp_rec (k:nat) (e_5:exp) (e__6:exp) {struct e__6}: exp :=
  ...
  | (e_pair e1 e2) => e_pair (open_exp_wrt_exp_rec k e_5 e1) (open_exp_wrt_exp_rec k e_5 e2)
  | (e_projl e) => e_projl (open_exp_wrt_exp_rec k e_5 e)
  | (e_projr e) => e_projr (open_exp_wrt_exp_rec k e_5 e)
...
Inductive lc_exp : exp -> Prop :=    (* defn lc_exp *)
 ...
 | lc_e_pair : forall (e1 e2:exp),
     (lc_exp e1) ->
     (lc_exp e2) ->
     (lc_exp (e_pair e1 e2))
 | lc_e_projl : forall (e:exp),
     (lc_exp e) ->
     (lc_exp (e_projl e))
 | lc_e_projr : forall (e:exp),
     (lc_exp e) ->
     (lc_exp (e_projr e))
...
Inductive lc_dexp : dexp -> Prop :=    (* defn lc_dexp *)
 ...
 | lc_de_pair : forall (ee1 ee2:dexp),
     (lc_dexp ee1) ->
     (lc_dexp ee2) ->
     (lc_dexp (de_pair ee1 ee2))
 | lc_de_projl : forall (ee:dexp),
     (lc_dexp ee) ->
     (lc_dexp (de_projl ee))
 | lc_de_projr : forall (ee:dexp),
     (lc_dexp ee) ->
     (lc_dexp (de_projr ee))
...
Fixpoint fv_exp (e_5:exp) : vars :=
  ...
  | (e_pair e1 e2) => (fv_exp e1) \u (fv_exp e2)
  | (e_projl e) => (fv_exp e)
  | (e_projr e) => (fv_exp e)
  | (e_anno e A) => (fv_exp e)
end.
...
Fixpoint fv_dexp (ee_5:dexp) : vars :=
  ...
  | (de_pair ee1 ee2) => (fv_dexp ee1) \u (fv_dexp ee2)
  | (de_projl ee) => (fv_dexp ee)
  | (de_projr ee) => (fv_dexp ee)
...
Fixpoint subst_exp (e_5:exp) (x5:var) (e__6:exp) {struct e__6} : exp :=
  ...
  | (e_pair e1 e2) => e_pair (subst_exp e_5 x5 e1) (subst_exp e_5 x5 e2)
  | (e_projl e) => e_projl (subst_exp e_5 x5 e)
  | (e_projr e) => e_projr (subst_exp e_5 x5 e)
...
Fixpoint subst_dexp (ee_5:dexp) (x5:var) (ee__6:dexp) {struct ee__6} : dexp :=
  ...
  | (de_pair ee1 ee2) => de_pair (subst_dexp ee_5 x5 ee1) (subst_dexp ee_5 x5 ee2)
  | (de_projl ee) => de_projl (subst_dexp ee_5 x5 ee)
  | (de_projr ee) => de_projr (subst_dexp ee_5 x5 ee)
...
Inductive disjoint : typ -> typ -> Prop :=    (* defn disjoint *)
 ...
 | D_IntProd : forall (A1 A2:typ),
     disjoint t_int (t_prod A1 A2)
 | D_ProdInt : forall (A1 A2:typ),
     disjoint (t_prod A1 A2) t_int
 | D_ArrProd : forall (A1 A2 B1 B2:typ),
     disjoint (t_arrow A1 A2) (t_prod B1 B2)
 | D_ProdArr : forall (A1 A2 B1 B2:typ),
     disjoint (t_prod A1 A2) (t_arrow B1 B2)
 | D_Prod : forall (A1 A2 B1 B2:typ),
     disjoint A1 B1 ->
     disjoint A2 B2 ->
     disjoint (t_prod A1 A2) (t_prod B1 B2).
...
Inductive sub : typ -> typ -> Prop :=    (* defn sub *)
 ...
 | S_prod : forall (A1 A2 B1 B2:typ),
     sub A1 B1 ->
     sub A2 B2 ->
     sub (t_prod A1 A2) (t_prod B1 B2)
...
Inductive subsub : typ -> typ -> Prop :=    (* defn subsub *)
 ...
 | SubSub_prod : forall (A1 A2 B1 B2:typ),
     subsub A1 B1 ->
     subsub A2 B2 ->
...
Inductive arrTyp : typ -> typ -> Prop :=    (* defn arrTyp *)
 ...
 | AT_prod : forall (A B:typ),
     arrTyp (t_prod A B) (t_prod A B)
 | AT_topProd : 
     arrTyp t_top (t_prod t_top t_top).
...
Inductive TypedReduce : exp -> typ -> exp -> Prop :=    (* defn TypedReduce *)
 ...
 | TReduce_pair : forall (v1 v2:exp) (A B:typ) (v1' v2':exp),
      not ( topLike (t_prod A B) )  ->
     TypedReduce v1 A v1' ->
     TypedReduce v2 B v2' ->
     TypedReduce (e_pair v1 v2) (t_prod A B) (e_pair v1' v2')
with step : exp -> exp -> Prop :=    (* defn step *)
 | Step_topApp : forall (v:exp),
     value v ->
     step (e_app e_top v) e_top
 | Step_topProjl : 
     step (e_projl e_top) e_top
 | Step_topProjr : 
     step (e_projr e_top) e_top
 ...
 | Step_projl : forall (e e':exp),
     step e e' ->
     step (e_projl e) (e_projl e')
 | Step_projlv : forall (v1 v2:exp),
     value v1 ->
     value v2 ->
     step (e_projl  ( (e_pair v1 v2) ) ) v1
 | Step_projr : forall (e e':exp),
     step e e' ->
     step (e_projr e) (e_projr e')
 | Step_projrv : forall (v1 v2:exp),
     value v1 ->
     value v2 ->
     step (e_projr  ( (e_pair v1 v2) ) ) v2
...
Inductive Typing : ctx -> exp -> dirflag -> typ -> Prop :=    (* defn Typing *)
 ...
 | Typ_prod : forall (G:ctx) (e1 e2:exp) (A B:typ),
     Typing G e1 Inf A ->
     Typing G e2 Inf B ->
     Typing G (e_pair e1 e2) Inf (t_prod A B)
 | Typ_projl : forall (G:ctx) (e:exp) (A C B:typ),
     Typing G e Inf C ->
     arrTyp C (t_prod A B) ->
     Typing G (e_projl e) Inf A
 | Typ_projr : forall (G:ctx) (e:exp) (B C A:typ),
     Typing G e Inf C ->
     arrTyp C (t_prod A B) ->
     Typing G (e_projr e) Inf B
...
Inductive ITyping : ctx -> dexp -> dirflag -> typ -> exp -> Prop :=    (* defn ITyping *)
 ...
 | ITyp_prod : forall (G:ctx) (ee1 ee2:dexp) (A B:typ) (e1 e2:exp),
     ITyping G ee1 Inf A e1 ->
     ITyping G ee2 Inf B e2 ->
     ITyping G (de_pair ee1 ee2) Inf (t_prod A B) (e_pair e1 e2)
 | ITyp_projl : forall (G:ctx) (ee:dexp) (A:typ) (e:exp) (B:typ),
     ITyping G ee Inf (t_prod A B) e ->
     ITyping G (de_projl ee) Inf A (e_projl e)
 | ITyp_projr : forall (G:ctx) (ee:dexp) (B:typ) (e:exp) (A:typ),
     ITyping G ee Inf (t_prod A B) e ->
     ITyping G (de_projl ee) Inf B (e_projr e)
