...
Lemma meg_exp_lc : forall e1 e2,
    lc_exp e1 -> lc_exp e2 -> lc_exp (meg_exp e1 e2).
Proof.
  introv Lc1 Lc2.
  destruct e1; destruct e2; simpl; eauto.
Qed.
...
#[export] Hint Immediate papp_1_lc papp_2_lc meg_exp_lc papp_3_lc : core.
...
Proof.
  ...
  - (* app *)
    forwards* (?&?&?): IHTyp1.
    forwards* (?&?&?): IHTyp2.
    forwards* (?&?&?): arrTyp_subsub H H1.
    forwards (?&?&?): arrTyp_arrow_form H4. subst.
...
Proof.
  ...
  - (* proj *)
    forwards*: IHTy1. subst. forwards*: rcdTyp_unique H H4.
  - (* rcd *)
